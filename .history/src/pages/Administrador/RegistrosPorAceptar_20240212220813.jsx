          ...
          {registrosFiltrados.map((usuario) => (
            <tr className='fila__tabla' key={usuario._id}>
              ...
              <td className='cuerpo__tabla botones__tabla'>
                <button className="boton__aceptar"onClick={handleClickEstado(usuario._id)}>Aceptar</button> 
                <button className="boton__rechazar" onClick={handleClickRechazar(usuario._id)}>Rechazar</button> 
              </td>
            </tr>
          ))}
        </tbody>
