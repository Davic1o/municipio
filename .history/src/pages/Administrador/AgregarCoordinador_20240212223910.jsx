...
function AgregarCoordinador() {
  ...
  const registrosFiltrados = datos.filter((usuario) => usuario.estado === true && usuario.tipo ==='Usuario');
        ...
        <tbody>
          {registrosFiltrados.map((usuario) => (
            <tr className='fila__tabla' key={usuario._id}>
              ...
              <button className="boton__aceptar boton__coordinador" onClick={() => handleClickCoordinador(usuario._id)}>Hacer Coordinador</button>
