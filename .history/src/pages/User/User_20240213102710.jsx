...
import PanelLateral from '../../components/PanelLateralUser';
import AdministrarUser from './AdministrarUser'; // Importa el componente correspondiente
import EscogerRonda from './EscogerRonda';
  ...
  return (
    <div className="admin__container">
      ...
      <div className="contenido__derecho">
        ...
        {seccionActual === 'AdministrarUser' && <AdministrarUser user={userData} />}
        {seccionActual === 'UsuariosAsignados' && <EscogerRonda user={userData}/>}
