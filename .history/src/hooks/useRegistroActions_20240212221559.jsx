...
const useRegistroActions = () => {
  ...
  const handleClickAgregarCoord= async (userId, data) => {
    try {
      // Encontrar el usuario correspondiente en los datos
      const userToUpdate = data.find((user) => user._id === userId);
  ...
  return { handleEstado, handleAprobacion, handleEstadoN, handleAprobacionN, handleClickAgregarCoord, data, setData };
};
